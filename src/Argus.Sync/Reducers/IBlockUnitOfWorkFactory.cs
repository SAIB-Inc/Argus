...
/// The framework calls <see cref="Create"/> once at the start of each branch's
/// processing for each block, and disposes the UoW (commit or rollback) when
